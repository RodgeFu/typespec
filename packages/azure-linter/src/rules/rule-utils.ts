...
import { RenameResponse } from "../lm/types.js";
...
export function getDecratorStringArgValue(dec: DecoratorApplication, argIndex: number): string | undefined {
